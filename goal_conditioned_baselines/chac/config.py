...
DEFAULT_PARAMS = {
    ...
    # taken from baselines.interface.click_options
...
ROLLOUT_PARAMS_LIST = ['T', 'rollout_batch_size', 'env_name', 'graph', 'time_scales']
...
def prepare_params(kwargs):
    ...
    if 'render' in registry[env_name].kwargs:
        registry[env_name].kwargs['render'] = kwargs['render']
...
def configure_policy(dims, params, env):
