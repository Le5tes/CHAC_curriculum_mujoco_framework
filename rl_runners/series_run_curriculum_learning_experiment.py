...
def run_curriculum_learn_experiment(savepath):
    ...
    for difficulty in difficulties:
       run_hac(f"{savepath}/non-curriculum-{difficulty}", 100, difficulty, False, num_cpu=10, bind_core=1)

    run_hac(f"{savepath}/non-curriculum-{difficulty}", 100, 0.0, True, num_cpu=10, bind_core=1)